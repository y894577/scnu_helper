...
// 使用案例
    ...
    wx.cloud.getTempFileURL({
      fileList: ['cloud://scnu-dev-iyplf.7363-scnu-dev-iyplf-1259750702/nanhai/' + options.name + '.md'],
      success: res => {
    ...
    app.getText(app.docDir + 'nanhai/' + options.name + '.md', (res) => {
      if (res.data) {
  ...
  onShareAppMessage: function () {
    ...
    return {
      ...
      path: 'pages/nanhai/book/index?name=' + this.data.name,
