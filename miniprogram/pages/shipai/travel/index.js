...
const App = getApp();
var src_longitude = 113.352078;
var src_latitude = 23.139350;
...
Page({
  ...
  //点击【保存图片】按钮触发
  onClick_SaveImage1: function()
  {
    wx.navigateTo({
      url: '/pages/shipai/travel/save_image1/index'
    });
  },

  onClick_SaveImage2: function()
  {
    wx.navigateTo({
      url: '/pages/shipai/travel/save_image2/index'
    });
  },
