...
// 使用案例
    ...
    wx.cloud.getTempFileURL({
      fileList: ['cloud://scnu-dev-iyplf.7363-scnu-dev-iyplf-1259750702/daxuecheng/' + options.name + '.md'],
      success: res => {
    ...
    app.getText(app.docDir + 'daxuecheng/' + options.name + '.md', (res) => {
      if (res.data) {
  ...
  onShareAppMessage: function () {
    ...
    return {
      ...
      path: 'pages/daxuecheng/book/index?name=' + this.data.name,
